	...
	return &plugin.Table{
		...
		Columns: k8sCommonColumns([]*plugin.Column{
			...
			//// PodSpec Columns
			{
				...
				Transform:   transform.FromField("Volumes"),
			},
			{
				Name:        "containers",
				Type:        proto.ColumnType_JSON,
				Description: "List of containers belonging to the pod.",
				Transform:   transform.FromField("Containers"),
			},
			{
				...
				Transform: transform.FromField("EphemeralContainers"),
			},
			{
			...
			},
			{
				...
				Transform: transform.FromField("TerminationGracePeriodSeconds"),
			},
			{
			...
			// },
			{
				...
				Transform:   transform.FromField("AutomountServiceAccountToken"),
			},
			{
				Name: "node_name",
				Type: proto.ColumnType_STRING,
			...
			},
			{
				...
				Transform: transform.FromField("HostNetwork"),
			},
			{
				Name:        "host_pid",
				Type:        proto.ColumnType_BOOL,
				Description: "Use the host's pid namespace.",
				Transform:   transform.FromField("HostPID"),
			},
			{
				Name:        "host_ipc",
				Type:        proto.ColumnType_BOOL,
				Description: "Use the host's ipc namespace.",
				Transform:   transform.FromField("HostIPC"),
			},
			{
				...
				Transform: transform.FromField("ShareProcessNamespace"),
			},
			{
				Name:        "security_context",
				Type:        proto.ColumnType_JSON,
				Description: "SecurityContext holds pod-level security attributes and common container settings.",
				Transform:   transform.FromField("SecurityContext"),
			},

			{
				...
				Transform:   transform.FromField("ImagePullSecrets"),
			},
			{
				Name:        "hostname",
				Type:        proto.ColumnType_STRING,
			...
			},
			{
				...
				Transform: transform.FromField("Subdomain"),
			},
			{
				Name:        "affinity",
				Type:        proto.ColumnType_JSON,
				Description: "If specified, the pod's scheduling constraints.",
				Transform:   transform.FromField("Affinity"),
			},
			{
				Name:        "scheduler_name",
				Type:        proto.ColumnType_STRING,
				Description: "If specified, the pod will be dispatched by specified scheduler.",
				Transform:   transform.FromField("SchedulerName"),
			},
			{
				Name:        "tolerations",
				Type:        proto.ColumnType_JSON,
				Description: "If specified, the pod's tolerations.",
				Transform:   transform.FromField("Tolerations"),
			},
			{
				Name: "host_aliases",
				Type: proto.ColumnType_JSON,
				...
				Transform: transform.FromField("HostAliases"),
			},
			{
				...
				Transform: transform.FromField("PriorityClassName"),
			},
			{
				Name: "priority",
				Type: proto.ColumnType_INT,
			...
			},
			{
				...
				Transform: transform.FromField("DNSConfig"),
			},

			{
				...
				Transform: transform.FromField("ReadinessGates"),
			},
			{
				...
				Transform: transform.FromField("RuntimeClassName"),
			},
			{
				...
				Transform: transform.FromField("EnableServiceLinks"),
			},
			{
			...
			},
			{
				...
				Transform: transform.FromField("TopologySpreadConstraints"),
			},
			{
				...
				Transform: transform.FromField("SetHostnameAsFQDN"),
			},
