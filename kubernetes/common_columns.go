...
// 	{Name: "kind", Type: proto.ColumnType_JSON, Description: "Kind is a string value representing the REST resource this object represents."},
...
var kubectlConfigColumns = []*plugin.Column{
	{
		Name:        "context_name",
