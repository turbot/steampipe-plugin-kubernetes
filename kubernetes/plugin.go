...
func pluginTableDefinitions(ctx context.Context, d *plugin.TableMapData) (map[string]*plugin.Table, error) {
	...
	tables := map[string]*plugin.Table{
		...
		"kubernetes_manifest_config_map":        tableKubernetesManifestConfigMap(ctx),
		"kubernetes_manifest_cron_job":          tableKubernetesManifestCronJob(ctx),
		"kubernetes_manifest_daemonset":         tableKubernetesManifestDaemonSet(ctx),
