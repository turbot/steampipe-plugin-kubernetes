...
Plugin also supports for Kubernetes clusters with [OIDC](https://kubernetes.io/docs/reference/access-authn-authz/authentication/#openid-connect-tokens) (OpenID Connect) authentication mechanism. This is based on community based user testing. In case any limitation, you can raise issue [here.](https://github.com/turbot/steampipe-plugin-kubernetes/issues)
